...
export const protobufPackage = "memos.server";
...
export function workspaceSettingKeyFromJSON(object: any): WorkspaceSettingKey {
  switch (object) {
    ...
    case 1:
    case "BASIC":
      return WorkspaceSettingKey.BASIC;
    case 2:
    case "GENERAL":
      return WorkspaceSettingKey.GENERAL;
    case 3:
    case "STORAGE":
      return WorkspaceSettingKey.STORAGE;
    case 4:
    case "MEMO_RELATED":
      return WorkspaceSettingKey.MEMO_RELATED;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function workspaceSettingKeyToNumber(object: WorkspaceSettingKey): number {
  switch (object) {
    case WorkspaceSettingKey.WORKSPACE_SETTING_KEY_UNSPECIFIED:
      return 0;
    case WorkspaceSettingKey.BASIC:
      return 1;
    case WorkspaceSettingKey.GENERAL:
      return 2;
    case WorkspaceSettingKey.STORAGE:
      return 3;
    case WorkspaceSettingKey.MEMO_RELATED:
      return 4;
...
export interface WorkspaceSetting {
  ...
  basicSetting?: WorkspaceBasicSetting | undefined;
...
export interface WorkspaceBasicSetting {
...
export enum WorkspaceStorageSetting_StorageType {
  ...
  /** DATABASE - STORAGE_TYPE_DATABASE is the database storage type. */
  DATABASE = "DATABASE",
  /** LOCAL - STORAGE_TYPE_LOCAL is the local storage type. */
  LOCAL = "LOCAL",
  /** S3 - STORAGE_TYPE_S3 is the S3 storage type. */
  S3 = "S3",
  UNRECOGNIZED = "UNRECOGNIZED",
}
...
export const WorkspaceSetting: MessageFns<WorkspaceSetting> = {
  encode(message: WorkspaceSetting, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.basicSetting !== undefined) {
      WorkspaceBasicSetting.encode(message.basicSetting, writer.uint32(18).fork()).join();
    }
    if (message.generalSetting !== undefined) {
      WorkspaceGeneralSetting.encode(message.generalSetting, writer.uint32(26).fork()).join();
    }
    if (message.storageSetting !== undefined) {
      WorkspaceStorageSetting.encode(message.storageSetting, writer.uint32(34).fork()).join();
    }
    if (message.memoRelatedSetting !== undefined) {
      WorkspaceMemoRelatedSetting.encode(message.memoRelatedSetting, writer.uint32(42).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.basicSetting = WorkspaceBasicSetting.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromPartial(object: DeepPartial<WorkspaceSetting>): WorkspaceSetting {
    ...
    message.basicSetting = (object.basicSetting !== undefined && object.basicSetting !== null)
      ? WorkspaceBasicSetting.fromPartial(object.basicSetting)
      : undefined;
...
function createBaseWorkspaceBasicSetting(): WorkspaceBasicSetting {
  return { secretKey: "", schemaVersion: "" };
}

export const WorkspaceBasicSetting: MessageFns<WorkspaceBasicSetting> = {
  encode(message: WorkspaceBasicSetting, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WorkspaceBasicSetting {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseWorkspaceBasicSetting();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  create(base?: DeepPartial<WorkspaceBasicSetting>): WorkspaceBasicSetting {
    return WorkspaceBasicSetting.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<WorkspaceBasicSetting>): WorkspaceBasicSetting {
    const message = createBaseWorkspaceBasicSetting();
...
export const WorkspaceStorageSetting: MessageFns<WorkspaceStorageSetting> = {
  encode(message: WorkspaceStorageSetting, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.s3Config !== undefined) {
      StorageS3Config.encode(message.s3Config, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
function createBaseStorageS3Config(): StorageS3Config {
  return { accessKeyId: "", accessKeySecret: "", endpoint: "", region: "", bucket: "", usePathStyle: false };
}

export const StorageS3Config: MessageFns<StorageS3Config> = {
  encode(message: StorageS3Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StorageS3Config {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStorageS3Config();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  create(base?: DeepPartial<StorageS3Config>): StorageS3Config {
    return StorageS3Config.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<StorageS3Config>): StorageS3Config {
    const message = createBaseStorageS3Config();
