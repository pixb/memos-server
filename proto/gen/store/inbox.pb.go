...
type InboxMessage struct {
	...
	Type          InboxMessage_Type      `protobuf:"varint,1,opt,name=type,proto3,enum=memos.server.InboxMessage_Type" json:"type,omitempty"`
...
const file_store_inbox_proto_rawDesc = "" +
	"\n" +
	"\x11store/inbox.proto\x12\fmemos.server\"\xbd\x01\n" +
	"\fInboxMessage\x123\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1f.memos.server.InboxMessage.TypeR\x04type\x12$\n" +
	...
	"\f_activity_idB\x9d\x01\n" +
	"\x10com.memos.serverB\n" +
	"InboxProtoP\x01Z,github.com/pixb/memos-server/proto/gen/store\xa2\x02\x03MSX\xaa\x02\fMemos.Server\xca\x02\fMemos\\Server\xe2\x02\x18Memos\\Server\\GPBMetadata\xea\x02\rMemos::Serverb\x06proto3"
...
var file_store_inbox_proto_goTypes = []any{
	(InboxMessage_Type)(0), // 0: memos.server.InboxMessage.Type
	(*InboxMessage)(nil),   // 1: memos.server.InboxMessage
}
var file_store_inbox_proto_depIdxs = []int32{
	0, // 0: memos.server.InboxMessage.type:type_name -> memos.server.InboxMessage.Type
