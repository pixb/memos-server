...
type UserSetting struct {
	...
	Key    UserSettingKey         `protobuf:"varint,2,opt,name=key,proto3,enum=memos.server.UserSettingKey" json:"key,omitempty"`
...
const file_store_user_setting_proto_rawDesc = "" +
	"\n" +
	"\x18store/user_setting.proto\x12\fmemos.server\"\xd8\x02\n" +
	"\vUserSetting\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x05R\x06userId\x12.\n" +
	"\x03key\x18\x02 \x01(\x0e2\x1c.memos.server.UserSettingKeyR\x03key\x12L\n" +
	"\raccess_tokens\x18\x03 \x01(\v2%.memos.server.AccessTokensUserSettingH\x00R\faccessTokens\x12\x18\n" +
	"\x06locale\x18\x04 \x01(\tH\x00R\x06locale\x12 \n" +
	"\n" +
	"appearance\x18\x05 \x01(\tH\x00R\n" +
	"appearance\x12)\n" +
	"\x0fmemo_visibility\x18\x06 \x01(\tH\x00R\x0ememoVisibility\x12B\n" +
	"\tshortcuts\x18\a \x01(\v2\".memos.server.ShortcutsUserSettingH\x00R\tshortcutsB\a\n" +
	"\x05value\"\xc5\x01\n" +
	"\x17AccessTokensUserSetting\x12V\n" +
	"\raccess_tokens\x18\x01 \x03(\v21.memos.server.AccessTokensUserSetting.AccessTokenR\faccessTokens\x1aR\n" +
	"\vAccessToken\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\"\xab\x01\n" +
	"\x14ShortcutsUserSetting\x12I\n" +
	"\tshortcuts\x18\x01 \x03(\v2+.memos.server.ShortcutsUserSetting.ShortcutR\tshortcuts\x1aH\n" +
	"\bShortcut\x12\x0e\n" +
	...
	"\tSHORTCUTS\x10\x05B\xa3\x01\n" +
	"\x10com.memos.serverB\x10UserSettingProtoP\x01Z,github.com/pixb/memos-server/proto/gen/store\xa2\x02\x03MSX\xaa\x02\fMemos.Server\xca\x02\fMemos\\Server\xe2\x02\x18Memos\\Server\\GPBMetadata\xea\x02\rMemos::Serverb\x06proto3"
...
var file_store_user_setting_proto_goTypes = []any{
	(UserSettingKey)(0),                         // 0: memos.server.UserSettingKey
	(*UserSetting)(nil),                         // 1: memos.server.UserSetting
	(*AccessTokensUserSetting)(nil),             // 2: memos.server.AccessTokensUserSetting
	(*ShortcutsUserSetting)(nil),                // 3: memos.server.ShortcutsUserSetting
	(*AccessTokensUserSetting_AccessToken)(nil), // 4: memos.server.AccessTokensUserSetting.AccessToken
	(*ShortcutsUserSetting_Shortcut)(nil),       // 5: memos.server.ShortcutsUserSetting.Shortcut
}
var file_store_user_setting_proto_depIdxs = []int32{
	0, // 0: memos.server.UserSetting.key:type_name -> memos.server.UserSettingKey
	2, // 1: memos.server.UserSetting.access_tokens:type_name -> memos.server.AccessTokensUserSetting
	3, // 2: memos.server.UserSetting.shortcuts:type_name -> memos.server.ShortcutsUserSetting
	4, // 3: memos.server.AccessTokensUserSetting.access_tokens:type_name -> memos.server.AccessTokensUserSetting.AccessToken
	5, // 4: memos.server.ShortcutsUserSetting.shortcuts:type_name -> memos.server.ShortcutsUserSetting.Shortcut
