...
const file_store_memo_proto_rawDesc = "" +
	"\n" +
	"\x10store/memo.proto\x12\fmemos.server\"\xc2\x03\n" +
	"\vMemoPayload\x12>\n" +
	"\bproperty\x18\x01 \x01(\v2\".memos.server.MemoPayload.PropertyR\bproperty\x12>\n" +
	"\blocation\x18\x02 \x01(\v2\".memos.server.MemoPayload.LocationR\blocation\x12\x12\n" +
	...
	"\tlongitude\x18\x03 \x01(\x01R\tlongitudeB\x9c\x01\n" +
	"\x10com.memos.serverB\tMemoProtoP\x01Z,github.com/pixb/memos-server/proto/gen/store\xa2\x02\x03MSX\xaa\x02\fMemos.Server\xca\x02\fMemos\\Server\xe2\x02\x18Memos\\Server\\GPBMetadata\xea\x02\rMemos::Serverb\x06proto3"
...
var file_store_memo_proto_goTypes = []any{
	(*MemoPayload)(nil),          // 0: memos.server.MemoPayload
	(*MemoPayload_Property)(nil), // 1: memos.server.MemoPayload.Property
	(*MemoPayload_Location)(nil), // 2: memos.server.MemoPayload.Location
}
var file_store_memo_proto_depIdxs = []int32{
	1, // 0: memos.server.MemoPayload.property:type_name -> memos.server.MemoPayload.Property
	2, // 1: memos.server.MemoPayload.location:type_name -> memos.server.MemoPayload.Location
