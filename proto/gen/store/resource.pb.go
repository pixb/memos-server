...
const file_store_resource_proto_rawDesc = "" +
	"\n" +
	"\x14store/resource.proto\x12\fmemos.server\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dstore/workspace_setting.proto\"\x8a\x02\n" +
	"\x0fResourcePayload\x12E\n" +
	"\ts3_object\x18\x01 \x01(\v2&.memos.server.ResourcePayload.S3ObjectH\x00R\bs3Object\x1a\xa4\x01\n" +
	"\bS3Object\x12:\n" +
	"\ts3_config\x18\x01 \x01(\v2\x1d.memos.server.StorageS3ConfigR\bs3Config\x12\x10\n" +
	...
	"\x02S3\x10\x02\x12\f\n" +
	"\bEXTERNAL\x10\x03B\xa0\x01\n" +
	"\x10com.memos.serverB\rResourceProtoP\x01Z,github.com/pixb/memos-server/proto/gen/store\xa2\x02\x03MSX\xaa\x02\fMemos.Server\xca\x02\fMemos\\Server\xe2\x02\x18Memos\\Server\\GPBMetadata\xea\x02\rMemos::Serverb\x06proto3"
...
var file_store_resource_proto_goTypes = []any{
	(ResourceStorageType)(0),         // 0: memos.server.ResourceStorageType
	(*ResourcePayload)(nil),          // 1: memos.server.ResourcePayload
	(*ResourcePayload_S3Object)(nil), // 2: memos.server.ResourcePayload.S3Object
	(*StorageS3Config)(nil),          // 3: memos.server.StorageS3Config
	(*timestamppb.Timestamp)(nil),    // 4: google.protobuf.Timestamp
}
var file_store_resource_proto_depIdxs = []int32{
	2, // 0: memos.server.ResourcePayload.s3_object:type_name -> memos.server.ResourcePayload.S3Object
	3, // 1: memos.server.ResourcePayload.S3Object.s3_config:type_name -> memos.server.StorageS3Config
	4, // 2: memos.server.ResourcePayload.S3Object.last_presigned_time:type_name -> google.protobuf.Timestamp
