...
type IdentityProvider struct {
	...
	Type             IdentityProvider_Type   `protobuf:"varint,3,opt,name=type,proto3,enum=memos.server.IdentityProvider_Type" json:"type,omitempty"`
...
const file_store_idp_proto_rawDesc = "" +
	"\n" +
	"\x0fstore/idp.proto\x12\fmemos.server\"\x84\x02\n" +
	"\x10IdentityProvider\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x127\n" +
	"\x04type\x18\x03 \x01(\x0e2#.memos.server.IdentityProvider.TypeR\x04type\x12+\n" +
	"\x11identifier_filter\x18\x04 \x01(\tR\x10identifierFilter\x12<\n" +
	"\x06config\x18\x05 \x01(\v2$.memos.server.IdentityProviderConfigR\x06config\"(\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06OAUTH2\x10\x01\"e\n" +
	"\x16IdentityProviderConfig\x12A\n" +
	"\roauth2_config\x18\x01 \x01(\v2\x1a.memos.server.OAuth2ConfigH\x00R\foauth2ConfigB\b\n" +
	"\x06config\"\x86\x01\n" +
	...
	"\rfield_mapping\x18\a \x01(\v2\x1a.memos.server.FieldMappingR\ffieldMappingB\x9b\x01\n" +
	"\x10com.memos.serverB\bIdpProtoP\x01Z,github.com/pixb/memos-server/proto/gen/store\xa2\x02\x03MSX\xaa\x02\fMemos.Server\xca\x02\fMemos\\Server\xe2\x02\x18Memos\\Server\\GPBMetadata\xea\x02\rMemos::Serverb\x06proto3"
...
var file_store_idp_proto_goTypes = []any{
	(IdentityProvider_Type)(0),     // 0: memos.server.IdentityProvider.Type
	(*IdentityProvider)(nil),       // 1: memos.server.IdentityProvider
	(*IdentityProviderConfig)(nil), // 2: memos.server.IdentityProviderConfig
	(*FieldMapping)(nil),           // 3: memos.server.FieldMapping
	(*OAuth2Config)(nil),           // 4: memos.server.OAuth2Config
}
var file_store_idp_proto_depIdxs = []int32{
	0, // 0: memos.server.IdentityProvider.type:type_name -> memos.server.IdentityProvider.Type
	2, // 1: memos.server.IdentityProvider.config:type_name -> memos.server.IdentityProviderConfig
	4, // 2: memos.server.IdentityProviderConfig.oauth2_config:type_name -> memos.server.OAuth2Config
	3, // 3: memos.server.OAuth2Config.field_mapping:type_name -> memos.server.FieldMapping
