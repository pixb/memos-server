...
const file_store_activity_proto_rawDesc = "" +
	"\n" +
	"\x14store/activity.proto\x12\fmemos.server\"]\n" +
	...
	"\fmemo_comment\x18\x01 \x01(\v2(.memos.server.ActivityMemoCommentPayloadR\vmemoCommentB\xa0\x01\n" +
	"\x10com.memos.serverB\rActivityProtoP\x01Z,github.com/pixb/memos-server/proto/gen/store\xa2\x02\x03MSX\xaa\x02\fMemos.Server\xca\x02\fMemos\\Server\xe2\x02\x18Memos\\Server\\GPBMetadata\xea\x02\rMemos::Serverb\x06proto3"
...
var file_store_activity_proto_goTypes = []any{
	(*ActivityMemoCommentPayload)(nil), // 0: memos.server.ActivityMemoCommentPayload
	(*ActivityPayload)(nil),            // 1: memos.server.ActivityPayload
}
var file_store_activity_proto_depIdxs = []int32{
	0, // 0: memos.server.ActivityPayload.memo_comment:type_name -> memos.server.ActivityMemoCommentPayload
