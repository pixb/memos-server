...
type WorkspaceSetting struct {
	...
	Key   WorkspaceSettingKey    `protobuf:"varint,1,opt,name=key,proto3,enum=memos.server.WorkspaceSettingKey" json:"key,omitempty"`
...
type WorkspaceStorageSetting struct {
	...
	StorageType WorkspaceStorageSetting_StorageType `protobuf:"varint,1,opt,name=storage_type,json=storageType,proto3,enum=memos.server.WorkspaceStorageSetting_StorageType" json:"storage_type,omitempty"`
...
type WorkspaceMemoRelatedSetting struct {
	...
	// enable_blur_nsfw_content enables blurring of content marked as not safe for
	// work (NSFW).
...
const file_store_workspace_setting_proto_rawDesc = "" +
	"\n" +
	"\x1dstore/workspace_setting.proto\x12\fmemos.server\"\x9f\x03\n" +
	"\x10WorkspaceSetting\x123\n" +
	"\x03key\x18\x01 \x01(\x0e2!.memos.server.WorkspaceSettingKeyR\x03key\x12J\n" +
	"\rbasic_setting\x18\x02 \x01(\v2#.memos.server.WorkspaceBasicSettingH\x00R\fbasicSetting\x12P\n" +
	"\x0fgeneral_setting\x18\x03 \x01(\v2%.memos.server.WorkspaceGeneralSettingH\x00R\x0egeneralSetting\x12P\n" +
	"\x0fstorage_setting\x18\x04 \x01(\v2%.memos.server.WorkspaceStorageSettingH\x00R\x0estorageSetting\x12]\n" +
	"\x14memo_related_setting\x18\x05 \x01(\v2).memos.server.WorkspaceMemoRelatedSettingH\x00R\x12memoRelatedSettingB\a\n" +
	"\x05value\"]\n" +
	"\x15WorkspaceBasicSetting\x12\x1d\n" +
	"\n" +
	"secret_key\x18\x01 \x01(\tR\tsecretKey\x12%\n" +
	"\x0eschema_version\x18\x02 \x01(\tR\rschemaVersion\"\xd9\x03\n" +
	...
	"\x0ecustom_profile\x18\x05 \x01(\v2$.memos.server.WorkspaceCustomProfileR\rcustomProfile\x121\n" +
	...
	"\fstorage_type\x18\x01 \x01(\x0e21.memos.server.WorkspaceStorageSetting.StorageTypeR\vstorageType\x12+\n" +
	"\x11filepath_template\x18\x02 \x01(\tR\x10filepathTemplate\x12/\n" +
	"\x14upload_size_limit_mb\x18\x03 \x01(\x03R\x11uploadSizeLimitMb\x12:\n" +
	"\ts3_config\x18\x04 \x01(\v2\x1d.memos.server.StorageS3ConfigR\bs3Config\"L\n" +
	...
	"\fMEMO_RELATED\x10\x04B\xa8\x01\n" +
	"\x10com.memos.serverB\x15WorkspaceSettingProtoP\x01Z,github.com/pixb/memos-server/proto/gen/store\xa2\x02\x03MSX\xaa\x02\fMemos.Server\xca\x02\fMemos\\Server\xe2\x02\x18Memos\\Server\\GPBMetadata\xea\x02\rMemos::Serverb\x06proto3"
...
var file_store_workspace_setting_proto_goTypes = []any{
	(WorkspaceSettingKey)(0),                 // 0: memos.server.WorkspaceSettingKey
	(WorkspaceStorageSetting_StorageType)(0), // 1: memos.server.WorkspaceStorageSetting.StorageType
	(*WorkspaceSetting)(nil),                 // 2: memos.server.WorkspaceSetting
	(*WorkspaceBasicSetting)(nil),            // 3: memos.server.WorkspaceBasicSetting
	(*WorkspaceGeneralSetting)(nil),          // 4: memos.server.WorkspaceGeneralSetting
	(*WorkspaceCustomProfile)(nil),           // 5: memos.server.WorkspaceCustomProfile
	(*WorkspaceStorageSetting)(nil),          // 6: memos.server.WorkspaceStorageSetting
	(*StorageS3Config)(nil),                  // 7: memos.server.StorageS3Config
	(*WorkspaceMemoRelatedSetting)(nil),      // 8: memos.server.WorkspaceMemoRelatedSetting
}
var file_store_workspace_setting_proto_depIdxs = []int32{
	0, // 0: memos.server.WorkspaceSetting.key:type_name -> memos.server.WorkspaceSettingKey
	3, // 1: memos.server.WorkspaceSetting.basic_setting:type_name -> memos.server.WorkspaceBasicSetting
	4, // 2: memos.server.WorkspaceSetting.general_setting:type_name -> memos.server.WorkspaceGeneralSetting
	6, // 3: memos.server.WorkspaceSetting.storage_setting:type_name -> memos.server.WorkspaceStorageSetting
	8, // 4: memos.server.WorkspaceSetting.memo_related_setting:type_name -> memos.server.WorkspaceMemoRelatedSetting
	5, // 5: memos.server.WorkspaceGeneralSetting.custom_profile:type_name -> memos.server.WorkspaceCustomProfile
	1, // 6: memos.server.WorkspaceStorageSetting.storage_type:type_name -> memos.server.WorkspaceStorageSetting.StorageType
	7, // 7: memos.server.WorkspaceStorageSetting.s3_config:type_name -> memos.server.StorageS3Config
